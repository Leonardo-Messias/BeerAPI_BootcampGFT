...
public class SwaggerConfig {
    ...
    private static final String CONTACT_NAME = "Leonardo Messias";
    private static final String CONTACT_GITHUB = "https://github.com/Leonardo-Messias";
    private static final String CONTACT_EMAIL = "leonardo.messias@hotmail.com";
